# Content was taken from Fish distribution at
# /opt/homebrew/Cellar/fish/3.5.1/share/fish/functions/ls.fish
...
function ls --wraps=ls --description "List contents of directory with additional color coding via grc"
    ...
    grc --colour=auto $__fish_ls_command --color $opt $argv
end
